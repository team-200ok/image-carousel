...
const writeRestaurants = fs.createWriteStream('database/PostgreSQL/images9.csv');

const writeTable = (writer, encoding) => {
    console.log('writing images...')
    let i = 10000000;
    let restaurantId = 8000000;
    let counter = 0;
    const write = () => {
        let ok = true;
        do {
            ...
            if (i === 9000000) {
              console.log(`completed 10 percent of images9`);
            }
            if (i === 8000000) {
              console.log(`completed 20 percent of images9`);
            }
            if (i === 7000000) {
              console.log(`completed 30 percent of images9`);
            }
            if (i === 6000000) {
              console.log(`completed 40 percent of images9`);
            }
            if (i === 5000000) {
              console.log(`completed 50 percent of images9`);
            }
            if (i === 4000000) {
              console.log(`completed 60 percent of images9`);
            }
            if (i === 3000000) {
              console.log(`completed 70 percent of images9`);
            }
            if (i === 2000000) {
              console.log(`completed 80 percent of images9`);
            }
            if (i === 1000000) {
              console.log(`completed 90 percent of images9`);
            }
          } while ( i > 0 && ok);
              if (i > 0) {
